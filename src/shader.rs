...
impl Shader {
    ...
    pub fn from_source(file_path: &str, kind: gl::types::GLenum) -> Result<Shader> {
        let shader_source =
    ...
    pub fn from_vertex_source(file_path: &str) -> Result<Shader> {
        Shader::from_source(file_path, gl::VERTEX_SHADER)
    }

    pub fn from_fragment_source(file_path: &str) -> Result<Shader> {
        Shader::from_source(file_path, gl::FRAGMENT_SHADER)
    }
}
